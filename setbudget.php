...
<form action="<?php echo $_SERVER['PHP_SELF'] ;?>" method="post">
  ...
  <br>
    ...
    <br>
    <input class="box" placeholder="Transport" type="number"  name="trans" min="0">
    <input class="box" placeholder="Groceries" type="number"  name="grocery" min="0" ><br>
    <input class="box" placeholder="Basic Utilities" type="number" name="utility" min="0" >
    <input class="box" placeholder="House Bills" type="number"  name="bill" min="0" ><br>
    <input class="box" placeholder="Clothing" type="number" name="cloth" min="0" >
    <input class="box" placeholder="Education" type="number" name="edu" min="0" ><br>
    <input class="box" placeholder="Medication" type="number" name="med" min="0">
    <input class="box" placeholder="Leisure" type="number"  name="fun" min="0"><br>
    <input class="box" placeholder="Others" type="number" name="other" min="0"><span class="error"><br><?php echo $error;?></span>
